...
class _support extends \IPS\Dispatcher\Controller
{
	...
	{
		//IV
		\IPS\Output::i()->output = \IPS\Theme::i()->getTemplate( 'global' )->message( 'get_support_unsupported_ivnull', 'warning' );
	}
	...
	{	
		try
		{
			return \intval( (string) \IPS\Http\Url::iv( 'connectionCheck.php' )->request()->get() );
		}
		catch ( \Exception $e )
		{
