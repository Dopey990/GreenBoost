				...
				if ( mb_substr( $file, 0, 1 ) !== '.' AND $file != 'index.html' )
				{
					...
					else
					{
						...
						$buttons['delete'] = array(
							...
							'link'	=> \IPS\Http\Url::internal( "app=core&module=applications&controller=developer&appKey={$this->application->directory}&do=removeExtension&file={$name}&ext={$folder}" ),
							'data'	=> array( 'delete' => '' )
						);
					}
