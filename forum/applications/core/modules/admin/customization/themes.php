...
class _themes extends \IPS\Node\Controller
{
	...
	public function resources()
	{
		...
		$table->parsers = array(
			...
			{
				if ( \in_array( mb_substr( $row['resource_name'], mb_strrpos( $row['resource_name'], '.' ) + 1 ), array_merge( \IPS\Image::$imageExtensions, array( 'svg' ) ) ) )
				{
