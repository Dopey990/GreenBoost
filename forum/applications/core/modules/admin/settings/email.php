...
class _email extends \IPS\Dispatcher\Controller
{
	 ...
	 */
	public static function emailErrorLogTable( \IPS\Http\Url $url )
	{
		/* Create the table */
		$table = new \IPS\Helpers\Table\Db( 'core_mail_error_logs', $url );
	...
	public function errorLogResend()
	{
		...
		/* Remove notification since this was re-sent with success */
		\IPS\Data\Store::i()->failedMailCount = 0;
		\IPS\core\AdminNotification::remove( 'core', 'ConfigurationError', 'failedMail' );
