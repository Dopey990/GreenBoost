...
class _general extends \IPS\Dispatcher\Controller
{
	...
	protected function manage()
	{
		...
		if ( $values = $form->values() )
		{
			...
			//IV $values['usage_reporting'] = \in_array( 'usage', $values['diagnostics_reporting'] );
			//IV $values['diagnostics_reporting'] = \in_array( 'diagnostics', $values['diagnostics_reporting'] );
