...
class _advanced extends \IPS\Dispatcher\Controller
{
	...
	protected function _manageSettings()
	{
		...
		//IV
		$form->addHeader( 'server_error_notes' );
		$form->add( new \IPS\Helpers\Form\YesNo( 'disable_error_notes', \IPS\Settings::i()->disable_error_notes, FALSE ) );
		
		if ( \IPS\Settings::i()->show_all_settings )
		{
			$form->addHeader( 'connection_iv_url' );
