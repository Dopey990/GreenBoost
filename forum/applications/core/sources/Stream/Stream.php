...
class _Stream extends \IPS\Node\Model
{
	...
	public function form( &$form, $titleType='Translatable', $titleRequired=TRUE )
	{
		...
		$form->add( new \IPS\Helpers\Form\Interval( 'stream_date_relative_days', $this->date_relative_days ?: 7, NULL, array( 'valueAs' => \IPS\Helpers\Form\Interval::DAYS ), function( $val )
		{
	...
	protected function _getOurClubs()
	{
		...
		{
			static::$ourClubs = \IPS\Member\Club::clubs( NULL, NULL, 'name', FALSE, array(), \IPS\Settings::i()->clubs_require_approval ? array( 'approved=1' ) : NULL );
