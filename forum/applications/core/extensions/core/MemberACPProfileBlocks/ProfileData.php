...
class _ProfileData extends \IPS\core\MemberACPProfile\TabbedBlock
{
	...
	{
		$return = array();
		if ( \count( $this->fields ) || $this->member->member_title || $this->member->rank['title'] || $this->member->rank['image'] || \IPS\Settings::i()->profile_birthday_type != 'none' || \IPS\Settings::i()->signatures_enabled )
		{
