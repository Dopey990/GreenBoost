...
class _Reputation
{
	...
	public function getDescription( $filters )
	{
		if ( ! empty( $filters['reputation_score'] ) and $filters['reputation_score'] > 0 )
		{
			...
			{
				case 'gt':
					return \IPS\Member::loggedIn()->language()->addToStack( 'member_filter_core_reputation_gt_desc', NULL, array( 'sprintf' => array( $filters['reputation_score'] ) ) );
				break;
				case 'lt':
					return \IPS\Member::loggedIn()->language()->addToStack( 'member_filter_core_reputation_lt_desc', NULL, array( 'sprintf' => array( $filters['reputation_score'] ) ) );
				break;
				case 'eq':
					return \IPS\Member::loggedIn()->language()->addToStack( 'member_filter_core_reputation_eq_desc', NULL, array( 'sprintf' => array( $filters['reputation_score'] ) ) );
				break;
			}
		}
