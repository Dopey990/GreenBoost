...
class _Upgrade
{
	...
	public function step1()
	{
		...
		{
			\IPS\Db::i()->delete( 'core_acp_notifcations_dismissals', array( \IPS\Db::i()->in( 'notification', \IPS\Db::i()->select( 'id', 'core_acp_notifications', array( 'app=? AND ext=?', 'core', 'NewVersion' ) ) ) ) );
