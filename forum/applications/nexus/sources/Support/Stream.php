...
class _Stream extends \IPS\Patterns\ActiveRecord
{
	...
	public function updateFromForm( $values )
	{
		...
		$this->started = $values['r_started'][1] ? json_encode($values['r_started']): NULL;
		$this->last_new_reply = $values['r_last_new_reply'][1] ? json_encode($values['r_last_new_reply']): NULL;
		$this->last_reply = $values['r_last_reply'][1] ? json_encode($values['r_last_reply']): NULL;
		$this->last_staff_reply = $values['r_last_staff_reply'][1] ? json_encode($values['r_last_staff_reply']): NULL;
