...
class _submit extends \IPS\Dispatcher\Controller
{
	...
	{		
		...
		$steps['upload_files'] = function( $data )
		{
			...
			return \IPS\Theme::i()->getTemplate( 'submit' )->submitForm( $form, $category, $category->message('subterms'), ( \IPS\Member::loggedIn()->group['idm_bulk_submit'] && \IPS\Request::i()->bulk ), $postingInformation );
		};
