...
class _Downloads
{
	...
	public function process( &$form, $group )
	{
		...
		$form->add( new \IPS\Helpers\Form\Interval( 'idm_wait_period', $group->idm_wait_period, FALSE, array( 'valueAs' => \IPS\Helpers\Form\Interval::SECONDS, 'unlimited' => 0, 'unlimitedLang' => 'idm_throttling_unlimited' ) ) );
