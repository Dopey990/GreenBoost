...
$lang = array(
	...
	'license'				=> "License",
	'lkey'					=> "License Key",
	'lkey_help'				=> "Get License Key from Invision Virus",
	'license_generic_error'	=> "There was an error communicating with the IPS License Server. Please try again later or contact Invision Virus support for assistance.",
	'license_server_error'	=> "There was an error communicating with the IPS License Server: %s. Please try again later or contact Invision Virus support for assistance.",
	'license_key_not_found'	=> "The license key supplied is not valid. Please check the provided key and try again or contact Invision Virus support for more assistance.",
	'license_key_legacy'	=> "The license key supplied is not compatible with this version of Invision Community. Please contact Invision Virus support for assistance.",
	'license_key_active'	=> "An installation has already been activated for this license key. Your license key entitles you to one installation only. If you need to change the URL associated with your license, contact Invision Virus support.",
