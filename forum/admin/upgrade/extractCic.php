...
catch ( Throwable $e )
{
	...
	echo "<script type='text/javascript'>parent.location = parent.location + '&fail=1';</script><noscript>An error occurred. Please visit the Invision-Virus.com to manually download the latest version. After uploading the files, <a href='index.php' target='_parent'>continue to the upgrader</a>.</noscript>";
	exit;
}
?>
<script type='text/javascript'>
	...
	var phrases = [
		...
		"This would be a good time to check out what's new in our blog...",
