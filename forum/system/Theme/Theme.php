...
EOF;
	...
	{{if (!\$licenseData = \IPS\IPS::licenseKey() or !isset(\$licenseData['products']['copyright']) or !\$licenseData['products']['copyright']) and \IPS\Settings::i()->display_original_copyright}}<a rel='nofollow' title='Invision Community' href='" . \IPS\Http\Url::anonymizeurl( 'https://www.invisioncommunity.com/', FALSE ) . "'>Powered by Invision Community</a>{{endif}}
</p>";
		}
