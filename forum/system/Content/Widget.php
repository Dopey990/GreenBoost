...
abstract class _Widget extends \IPS\Widget\PermissionCache
{
	...
	public function configuration( &$form=null )
	{
		...
		if ( \in_array( 'IPS\Content\FuturePublishing', class_implements( $class ) ) )
		{
			...
			$form->add( new \IPS\Helpers\Form\Radio( 'widget_feed_status_published', isset( $this->configuration['widget_feed_status_published'] ) ? $this->configuration['widget_feed_status_published'] : 'any', FALSE, array( 'options' => $types ) ) );
		}
