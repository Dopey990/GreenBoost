...
abstract class _WidgetComment extends \IPS\Widget\PermissionCache
{
	...
	public function configuration( &$form=null )
	{
		...
		{
			$form->add( new \IPS\Helpers\Form\Select( 'widget_feed_comment_date', isset( $this->configuration['widget_feed_comment_date'] ) ? (int) $this->configuration['widget_feed_comment_date'] : 0, FALSE, array(
				'options' => array(
					0	=> $class::databaseTableCount() > \IPS\UPGRADE_LARGE_TABLE_SIZE ? 'search_year' : 'show_all',
					1	=> 'today',
					5	=> 'last_5_days',
					7	=> 'last_7_days',
					10	=> 'last_10_days',
	...
	protected function buildWhere()
	{
		...
		else if ( $class::databaseTableCount() > \IPS\UPGRADE_LARGE_TABLE_SIZE )
		{
