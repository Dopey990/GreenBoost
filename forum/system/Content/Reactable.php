...
trait Reactable
{
	...
	public function removeReaction( \IPS\Member $member = NULL )
	{
		...
		\IPS\Db::i()->delete( 'core_reputation_index', array( "app=? AND type=? AND type_id=? AND member_id=?", static::$application, static::reactionType(), $this->$idColumn, $member->member_id ) );
